...
#     requests_count+=1
#     request.span.set_attribute("requests_count", requests_count)
...
#         requests_count+=1
#         current_span.span.set_attribute("requests_count", requests_count)
...
#             })
#             error_count+=1
#             current_span.span.set_attribute("error_count", error_count)
